...
/**
 * Convert the basic lab (basic.cpp) --> baton.cpp into a coordinated, 
 * controlled, passing of an action. 
 * 
 * Why? There are times where an action or access to a resource is limited
 * to a single process. This type of action/control is referred to as 
 * passing the baton (i.e. In relay races, 800 m, a runner cannot start
 * without first passing the baton to the next runner in the leg).
 */
